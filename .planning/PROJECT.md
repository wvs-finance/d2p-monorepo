...
| Accent color: **muted ochre** `oklch(0.6 0.08 70)` ~ `#a87c3a` | User signoff 2026-05-12 from 4-candidate AskUserQuestion. Parchment-native warm earth tone; cohesive with cream canvas; "old book endpaper / first-edition economics text" register. Phase 2 UI-SPEC builds tokens from this. | ✓ Locked |
